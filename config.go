...
type Config struct {
	...
	DefaultOutput  string        `json:"default_output,omitempty" help:"Default output filename when -o is not specified." group:"Settings" default:"freeze.png" placeholder:"freeze.png"`
